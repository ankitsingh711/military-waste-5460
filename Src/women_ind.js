...
function displayPro(elem){
    ...
    place.innerText = "If order is placed within the 4 days then deleivery charges will not be added";
    ...
    imgdiv.append(img);
    tdiv.append(name,price,cat,rating,des,add,next,place,next2,van_icon,free);
